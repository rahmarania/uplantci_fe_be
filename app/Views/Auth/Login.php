...
<head>
    ...
    <title>Login &mdash; UPlant</title>
                    ...
                    <?php if (session()->getFlashdata('error')) : ?>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= site_url('auth/loginUser')?>" class="needs-validation" novalidate="">
                                    <?= csrf_field()?>
                                ...
                                <div class="text-center mt-4 mb-3">
                                    <a href="<?= site_url('auth/loginAdmin') ?>" class="text-job text-muted">Login as Admin</a>
                                </div>
