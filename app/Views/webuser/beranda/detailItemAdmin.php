   ...
   <!-- sidebar area end -->
      ...
      <main>
         ...
         <!-- <div class="page__title align-items-center theme-bg-primary-h1 pt-140 pb-140"> -->
            <div class="banner-area pt-200 pb-180" data-background="<?=base_url()?>/uplant-main/assets/img/bg/infotanaman.png">
            <div class="container">
                  <div class="row">
                     <div class="col-xl-12">
         ...
         <div class="project-details-area pt-120 pb-90">
            <div class="container">
               <div class="row">
                  <div class="col-xl-80 col-lg-10 col-md-10">
                     <div class="project-details-image">

                     <?php foreach ($uplantdetail as $key => $value) : ?>
                        <img src="<?= base_url('uplant-main/assets/img/' . $value->gambar_tanaman) ?>" alt="" class="img-fluid">
                        <div class="project-d-info">
                           <h5 class="project-d-info-title"><?= $value->nama_tanaman ?></h5>
               ...
               <div class="project-d-descriptiopn mt-70">
                  <span class="p-quote"><i class="fas fa-leaf"></i></span>
                  <p class="pl-130"><?= $value->deskripsi?></p>
               </div>
               ...
               <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                     <div class="footer-widget footer-col-5 mb-40">
                        ...
                        <a href="<?= site_url('auth/logoutUser') ?>">Logout</a>
                           </ul>
                     </div>
                  </div>
               </div>
