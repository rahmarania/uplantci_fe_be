                  ...
                  <div class="banner-content banner-content-2">
                     <div class="banner-info text-center">
                        ...
                        <div class="banner-button mt-30">
                           <a href="<?= site_url('artikelLog') ?>" class="tp-btn-h1" style="margin-left:-70px;">Mulai Sekarang</a>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="project-menu filter-button-group mb-40">
                     <button class="active" data-filter=".c1">Hias</button>
                     <button data-filter=".c2">Obat</button>
                     <button data-filter=".c3">Hidroponik</button>
                     <button data-filter=".c4">Buah</button>
                     <button data-filter=".c5">Sayur</button>
                  </div>
               </div>
            </div>
               <div class="row grid">
                  ...
                  <div class="col-lg-4 col-md-6 c1">
                     <div class="project-img mb-70">
                        <div class="inner-img"><a href="<?= site_url('beranda/detailItemLog/').$value->id_tanaman ?>"><img src="<?= base_url('uplant-main/assets/img/' . $value->gambar_tanaman) ?>" alt="" class="fluid"></a></div>
                        <div class="project-img-content">
                           <h4 class="project-sm-title"><a href="<?= site_url('beranda/detailItemLog/').$value->id_tanaman ?>"><?= $value->nama_tanaman ?></a></h4>
                        </div>
                     </div>
